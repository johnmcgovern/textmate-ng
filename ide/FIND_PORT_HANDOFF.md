...
Rules 1–49 — every rule earned across all ports — now live together in
[`ide/RULES.md`](RULES.md), so a survey reads the whole list instead of the 1–22
that used to sit here. Rules 1–22 were earned in this handoff; add new rules to
`RULES.md`, at the end, and never renumber.
