...
| `OakSavePanel` | — | **done** (`8efdb481` pin, `7ff4d208` extraction, Swift); `encoding::type` boxed as `OakEncodingOptions`, and a 12-line ObjC++ forwarder keeps the rule-15 block signature |
